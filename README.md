...
report (`212/33`) updates measured heating power and its EcoFlow-provided PV,
battery, and grid shares directly from MQTT, normally within a few seconds.
Its push updates cannot postpone the independent 30-second HTTP fallback. The
